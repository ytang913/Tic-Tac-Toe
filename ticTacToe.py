...
def check_game_over():
	...
	#check cross
	condition1 = markers[0][0] + markers[1][1] + markers [2][2] == 3 or markers[2][0] + markers[1][1] + markers [0][2] == 3
	condition2 =  markers[0][0] + markers[1][1] + markers [2][2] == -3 or markers[2][0] + markers[1][1] + markers [0][2] == -3
	if condition1:
		winner = 1
		game_over = True
	if condition2:
